...
olvassa a két pumpát és a három kalibrált analóg csatornát. Minden pillanatképet előbb
...
SQLite `user_version` értékével verziózott; a jelenlegi verzió `2`, ismeretlenül
...
majd beolvassa a három NI analóg bemenetet. Nem küld `REMOTE`, `RUN` vagy más
