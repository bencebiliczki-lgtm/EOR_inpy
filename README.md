...
A jelenlegi belépési pont szimulátoros PySide6 dashboardot indít. Hardvermódban
...
Developer módban a **Közvetlen eszközkezelés** külön kezelőfelületen,
hardvermód-aktiválás nélkül nyitható meg. A két pumpa egymástól és az
...
Az alkalmazás megőrzi az utoljára választott hardveres üzemmódot; a tényleges
kapcsolatot induláskor továbbra is a kötelező kapcsolatpróba és kezelői
megerősítés után hozza létre.
...
Minden beállítási menüpont ugyanazt az átméretezhető `Beállítások` ablakot
nyitja meg a megfelelő kategórián. A Visual Studio beállításaihoz hasonló
felületen bal oldalt található az Eszközök, Kalibráció és biztonság, Naplózás,
Megjelenés, Developer módban pedig a Vezérlési ciklus kategória. A tényleges
szerkesztőmezők ugyanennek az ablaknak a jobb oldalán jelennek meg; a kategóriák
nem nyitnak további beállítási ablakokat.

A diagnosztikai napló alapértelmezetten be van kapcsolva. A `Beállítások` →
`Naplózás…` oldalon teljesen ki- vagy
...
Az élő grafikon a figyelmeztetéseket sárga, a kritikus riasztásokat piros
ponttal jelöli. A pontra vitt kurzor megmutatja a magyar időt, a mérési
szakaszt, az okot és a pillanatnyi pumpanyomásokat.
